# Brouillon — clause de propriété des morceaux

⚠️ Ceci est un point de départ, pas un document juridique validé. Fais-le
relire par un avocat ou un expert-comptable avant de le publier comme
vraies CGU — surtout une fois que d'autres personnes que toi uploadent
...
**Signalement d'un usage non autorisé**

Un artiste qui constate qu'un de ses morceaux a été réutilisé sans son
accord peut le signaler à [ton adresse de contact], en indiquant le
morceau concerné et le lieu où l'usage non autorisé a été constaté.
